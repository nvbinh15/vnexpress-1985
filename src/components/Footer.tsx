      ...
      <div className="mx-auto max-w-[1200px] px-4 py-8 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-12 gap-6 text-[13px]">
        <div className="col-span-2 sm:col-span-3 lg:col-span-3">
          ...
          <p className="text-[12px] text-vne-mute mt-3 leading-snug">
            Báo điện tử VnExpress 1985
          </p>
          <p className="text-[12px] text-vne-mute mt-1 leading-snug">
            Tin nhanh Việt Nam ra thế giới xã hội chủ nghĩa.
          </p>
        ...
        <div className="col-span-1 sm:col-span-1 lg:col-span-2">
          ...
          <ul className="space-y-1 text-vne-mute">
            <li>VnExpress 1975</li>
            <li>VnExpress 1980</li>
            <li>VnExpress 1984</li>
            <li>Sổ tay mậu dịch 1983</li>
          </ul>
        </div>
        <div className="col-span-2 sm:col-span-3 lg:col-span-3">
          ...
          <ul className="space-y-1 text-vne-mute">
            ...
            <li>Email: contact@vnexpress1985.fake</li>
            <li>Quảng cáo: ads@vnexpress1985.fake</li>
            <li>Hợp tác xã: htx-relations@vnexpress1985.fake</li>
          </ul>
          <div className="mt-3 inline-flex items-center gap-2">
            ...
            <span className="text-[11px] text-vne-mute leading-tight">
              Tải app VnExpress 1985<br />trên máy tính điện tử Minsk-32
            </span>
          </div>
        </div>
      </div>
      <div className="border-t border-vne-line bg-[#fafafa]">
        <div className="mx-auto max-w-[1200px] px-4 py-3 text-[11px] text-vne-mute">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-1 mt-1">
            <span>© 1985 VnExpress 1985 (fan-fork). Một dự án châm biếm phi thương mại.</span>
            <span>Phiên bản 1985.09 — Cập nhật lúc 06:30 GMT+7</span>
          </div>
        </div>
      </div>
    </footer>
